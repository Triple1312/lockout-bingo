...
//import static net.abrikoos.blockout.item.BlockoutModItems.PLAYER_COMPASS_LOCATION;
//
//public class CustomCompassRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
//
//
//    public static final Identifier CUSTOM_PLAYER_COMPASS_TEXTURE = Identifier.of("blockout", "textures/item/player_compass.png");
//
//
//    @Override
