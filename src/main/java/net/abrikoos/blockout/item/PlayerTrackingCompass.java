...
public class PlayerTrackingCompass extends Item {
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        String playername = stack.get(BlockoutModItems.PLAYER_COMPASS);
        ...
        if (player != null) {
            ...
            BlockoutLogger.log(Objects.requireNonNull(stack.get(DataComponentTypes.LODESTONE_TRACKER)).forWorld((ServerWorld) world).toString());
        }
        super.inventoryTick(stack, world, entity, slot, selected);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ...
            if (!players.isEmpty()) {
                String currentName = stack.get(BlockoutModItems.PLAYER_COMPASS);
                int currentIndex = 0;
                if (currentName == null) {
                    stack.set(BlockoutModItems.PLAYER_COMPASS, players.get(0).getNameForScoreboard());
                } else {
                ...
                if (currentIndex == players.size() - 1) {
                    ...
                    stack.set(BlockoutModItems.PLAYER_COMPASS, player.getNameForScoreboard());
                    stack.set(DataComponentTypes.LODESTONE_TRACKER, new LodestoneTrackerComponent(Optional.of(GlobalPos.create(player.getEntityWorld().getRegistryKey(), player.getBlockPos())), true));
                } else {
                ...
                stack.set(DataComponentTypes.CUSTOM_NAME, Text.of("Tracking: " + stack.get(BlockoutModItems.PLAYER_COMPASS)));
            }
        }
