...
public class LootTableHandler {
    ...
    public static List<ItemStack> editLootDrops(LootTable loottable, LootContextParameterSet params, List<ItemStack> generatedLoot) {
        Supplier<?> target = () -> params.get(LootContextParameters.THIS_ENTITY);
        try {
            Object tgt = target.get();
            if (tgt instanceof DrownedEntity drowned) {
            ...
            } else if (tgt instanceof WitherSkeletonEntity witherSkeleton) {
