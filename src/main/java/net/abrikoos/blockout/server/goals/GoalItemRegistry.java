...
import static net.abrikoos.blockout.server.goals.BlockoutGoalTag.*;
...
public class GoalItemRegistry {
    ...
    public GoalItemRegistry() {
        ...
        items.add(GoalListItemV2.createImaged("Opponent takes fall damage", "opponent takes fall damage", 2, List.of(dont), "no_fall", List.of(Identifier.of("blockout:goalicon/other/fall_damage.png")))); // todo icon
        items.add(GoalListItemV2.createImaged("Opponent dies", "", 2, List.of(dont, die), "no_die", List.of(Identifier.of("blockout:goalicon/other/opponent.png")) ));
        items.add(GoalListItemV2.createImaged("Opponent dies 3 times", "", 2, List.of(dont, die, C3), "no_die_3", List.of(Identifier.of("blockout:goalicon/other/opponent.png"))).addBottomRight("3"));
        items.add(GoalListItemV2.createImaged("Opponent catches fire", "", 3, List.of(dont), "no_fire", List.of(Identifier.of("blockout", "goalicon/other/fire.png"))));
        ...
        items.add(GoalListItemV2.createImaged("dont touch water", "dont touch water", 1, List.of(dont), "no_water", List.of(Identifier.of("blockout:goalicon/block/water.png")))); // todo icon
        ...
        items.add(GoalListItemV2.createImaged("wear a trimmed armor piece", "", 3, List.of(armor), "wear_trimmed", List.of(Identifier.of("blockout:goalicon/item/armor/emerald_trimmed_iron_helmet.png"), Identifier.of("blockout:goalicon/item/armor/copper_trimmed_diamond_leggings.png"),Identifier.of("blockout:goalicon/item/armor/redstone_trimmed_gold_chestplate.png"), Identifier.of("blockout:goalicon/item/armor/quartz_trimmed_netherite_boots.png")) ));
        items.add(GoalListItemV2.createImaged("wear a fully trimmed armor set", "", 3, List.of(armor, C4), "wear_trimmed_set", List.of(Identifier.of("blockout:goalicon/item/armor/emerald_trimmed_iron_helmet.png"), Identifier.of("blockout:goalicon/item/armor/copper_trimmed_diamond_leggings.png"),Identifier.of("blockout:goalicon/item/armor/redstone_trimmed_gold_chestplate.png"), Identifier.of("blockout:goalicon/item/armor/quartz_trimmed_netherite_boots.png")) ));
...
//        items.add(GoalListItemV2.createImaged("eat honeycomb", "", 1, List.of(), "eat_honeycomb", List.of(Identifier.of("minecraft:textures/item/honeycomb.png"))));
        ...
        items.add(GoalListItemV2.createImaged("breed hoglins", "", 3, List.of(breed, nether), "breed_hoglins", List.of(Identifier.of("blockout:goalicon/entity/hoglin.png"))));
        items.add(GoalListItemV2.createImaged("breed striders", "", 3, List.of(breed, nether), "breed_striders", List.of(Identifier.of("blockout:goalicon/entity/strider.png"))));
        items.add(GoalListItemV2.createImaged("breed axolotls", "", 4, List.of(breed), "breed_axolotls", List.of(Identifier.of("blockout:goalicon/entity/axolotl.png"))));
        items.add(GoalListItemV2.createImaged("breed bees", "", 1, List.of(breed), "breed_bees", List.of(Identifier.of("blockout:goalicon/entity/bee.png"))));
        items.add(GoalListItemV2.createImaged("breed goats", "", 3, List.of(breed), "breed_goats", List.of(Identifier.of("blockout:goalicon/entity/goat.png"))));
        items.add(GoalListItemV2.createImaged("breed foxes", "", 3, List.of(breed), "breed_foxes", List.of(Identifier.of("blockout:goalicon/entity/fox.png"))));
        items.add(GoalListItemV2.createImaged("breed cats", "", 2, List.of(breed), "breed_cats", List.of(Identifier.of("blockout:goalicon/entity/cat.png"))));
        items.add(GoalListItemV2.createImaged("breed wolves", "", 2, List.of(breed), "breed_wolves", List.of(Identifier.of("blockout:goalicon/entity/wolf.png"))));
//        items.add(GoalListItemV2.createImaged("breed parrots", "", 2, List.of(breed), "breed_parrots", List.of(Identifier.of("blockout:goalicon/entity/parrot.png"))));
        items.add(GoalListItemV2.createImaged("breed rabbits", "", 3, List.of(breed), "breed_rabbits", List.of(Identifier.of("blockout:goalicon/entity/rabbit.png"))));
        items.add(GoalListItemV2.createImaged("breed llamas", "", 3, List.of(breed), "breed_llamas", List.of(Identifier.of("blockout:goalicon/entity/lama.png"))));
        items.add(GoalListItemV2.createImaged("breed horses", "", 3, List.of(breed), "breed_horses", List.of(Identifier.of("blockout:goalicon/entity/horse.png"))));
        items.add(GoalListItemV2.createImaged("breed pigs", "", 1, List.of(breed), "breed_pigs", List.of(Identifier.of("blockout:goalicon/entity/pig.png"))));
        items.add(GoalListItemV2.createImaged("breed turtles", "", 2, List.of(breed), "breed_turtles", List.of(Identifier.of("blockout:goalicon/entity/turtle.png"))));
        items.add(GoalListItemV2.createImaged("breed a mule", "", 4, List.of(breed), "breed_mule", List.of(Identifier.of("blockout:goalicon/entity/mule.png"))));
        items.add(GoalListItemV2.createImaged("breed chickens", "", 1, List.of(breed), "breed_chickens", List.of(Identifier.of("blockout:goalicon/entity/chicken.png"))));
        items.add(GoalListItemV2.createImaged("breed cows", "", 1, List.of(breed), "breed_cows", List.of(Identifier.of("blockout:goalicon/entity/cow.png"))));



        items.add(GoalListItemV2.createImaged("breed 5 unique animals", "", 1, List.of(breed, C5, unique), "breed_5", List.of(Identifier.of("blockout:goalicon/entity/cow.png"))).addBottomRight("5"));
        items.add(GoalListItemV2.createImaged("breed 10 unique animals", "", 3, List.of(breed, C10, unique), "breed_10", List.of(Identifier.of("blockout:goalicon/entity/cow.png"))).addBottomRight("10"));
        items.add(GoalListItemV2.createImaged("breed 15 unique animals", "", 4, List.of(breed, C15, unique), "breed_15", List.of(Identifier.of("blockout:goalicon/entity/cow.png"))).addBottomRight("15"));

        items.add(GoalListItemV2.createImaged("kill a piglin brute", "", 4, List.of(kill, nether), "kill_piglin_brute", List.of(Identifier.of("blockout:goalicon/entity/piglin_brute.png"))));
        items.add(GoalListItemV2.createImaged("kill zoglin", "", 3, List.of(kill, nether), "kill_zoglin", List.of(Identifier.of("blockout:goalicon/entity/zoglin.png"))));
        items.add(GoalListItemV2.createImaged("kill an endermite", "", 4, List.of(kill), "kill_endermite", List.of(Identifier.of("blockout:goalicon/entity/endermite.png"))));
        items.add(GoalListItemV2.createImaged("kill a silverfish", "", 3, List.of(kill), "kill_silverfish", List.of(Identifier.of("blockout:goalicon/entity/silverfish.png"))));
        items.add(GoalListItemV2.createImaged("kill a breeze", "", 4, List.of(kill), "kill_breeze", List.of(Identifier.of("blockout:goalicon/entity/breeze.png")))); // Assuming 'breeze' is a fictional entity for the example
        items.add(GoalListItemV2.createImaged("kill an elder guardian", "", 3, List.of(kill), "kill_elder_guardian", List.of(Identifier.of("blockout:goalicon/entity/elder_guardian.png"))));
        items.add(GoalListItemV2.createImaged("kill a ghast", "", 2, List.of(kill, nether), "kill_ghast", List.of(Identifier.of("blockout:goalicon/entity/ghast.png"))));
        items.add(GoalListItemV2.createImaged("kill a zombie villager", "", 2, List.of(kill), "kill_zillager", List.of(Identifier.of("blockout:goalicon/entity/zillager.png"))));
        items.add(GoalListItemV2.createImaged("kill a witch", "", 3, List.of(kill), "kill_witch", List.of(Identifier.of("blockout:goalicon/entity/witch.png"))));
        items.add(GoalListItemV2.createImaged("kill a stray", "", 3, List.of(kill), "kill_stray", List.of(Identifier.of("blockout:goalicon/entity/stray.png"))));
        items.add(GoalListItemV2.createImaged("kill a snow golem", "", 3, List.of(kill), "kill_snow_golem", List.of(Identifier.of("blockout:goalicon/entity/snow_golem.png"))));
        items.add(GoalListItemV2.createImaged("kill a blaze with a snowball", "", 4, List.of(kill, nether), "kill_blaze_snowball", List.of(Identifier.of("blockout:goalicon/entity/blaze.png"))));
        items.add(GoalListItemV2.createImaged("kill 7 unique hostile mobs", "", 1, List.of(kill, C7, unique), "kill_7", List.of(Identifier.of("blockout:goalicon/entity/zombie.png"))).addBottomRight("7"));
        items.add(GoalListItemV2.createImaged("kill 10 unique hostile mobs", "", 3, List.of(kill, C10, unique), "kill_10", List.of(Identifier.of("blockout:goalicon/entity/zombie.png"))).addBottomRight("10"));
        items.add(GoalListItemV2.createImaged("kill 15 unique hostile mobs", "", 4, List.of(kill, C15, unique), "kill_15", List.of(Identifier.of("blockout:goalicon/entity/zombie.png"))).addBottomRight("15"));
        items.add(GoalListItemV2.createImaged("kill jeb_", "", 4, List.of(kill), "kill_jeb_", List.of(Identifier.of("blockout:goalicon/entity/jeb.png"))));

        items.add(GoalListItemV2.createImaged("kill 100 hostile mobs", "", 4, List.of(kill, C100), "kill_100", List.of(Identifier.of("blockout:goalicon/entity/zombie.png"), Identifier.of("blockout:goalicon/entity/spider.png"), Identifier.of("blockout:goalicon/entity/bee.png"), Identifier.of("blockout:goalicon/entity/sheep.png"), Identifier.of("blockout:goalicon/entity/drowned.png"), Identifier.of("blockout:goalicon/entity/enderman.png"))).addBottomRight("100"));
        items.add(GoalListItemV2.createImaged("kill 30 undead mobs", "", 3, List.of(kill, C30), "undead_30", List.of(Identifier.of("blockout:goalicon/entity/zombie.png"), Identifier.of("blockout:goalicon/entity/zoglin.png"), Identifier.of("blockout:goalicon/entity/skeleton.png"), Identifier.of("blockout:goalicon/entity/zombified_piglin.png"), Identifier.of("blockout:goalicon/entity/phantom.png"), Identifier.of("blockout:goalicon/entity/bogged.png"), Identifier.of("blockout:goalicon/entity/zillager.png"))).addBottomRight("30"));
        items.add(GoalListItemV2.createImaged("kill 20 arthropods", "", 3, List.of(kill, C20), "arthropod_20", List.of(Identifier.of("blockout:goalicon/entity/spider.png"), Identifier.of("blockout:goalicon/entity/bee.png"), Identifier.of("blockout:goalicon/entity/endermite.png"), Identifier.of("blockout:goalicon/entity/cave_spider.png"), Identifier.of("blockout:goalicon/entity/silverfish.png"))).addBottomRight("20"));

        //use entity goals
        items.add(GoalListItemV2.createImaged("shear a bogged", "", 2, List.of(), "shear_bogged", List.of(Identifier.of("blockout:goalicon/entity/bogged.png"))));


        items.add(GoalListItemV2.createImaged("enter the nether", "", 2, List.of(advancement), "nether_adv", List.of(Identifier.of("blockout:goalicon/structures/nether_portal.png"))));
        ...
        items.add(GoalListItemV2.createImaged("ride a strider with a warped fungus on a stick", "", 4, List.of(ride, advancement, nether), "this_boat_has_legs_adv", List.of(Identifier.of("blockout:goalicon/entity/strider.png"))));
        ...
        items.add(GoalListItemV2.createImaged("make a golem", "", 2, List.of(advancement), "hired_help_adv", List.of(Identifier.of("blockout:goalicon/entity/iron_golem.png"))));
        ...
        items.add(GoalListItemV2.createImaged("tame 4 unique types of cats", "", 3, List.of(C4, tame, unique), "catalogue_4_adv", List.of(Identifier.of("blockout:goalicon/entity/cat.png"))));
        items.add(GoalListItemV2.createImaged("tame 3 unique types of wolves", "", 4, List.of(C3, tame, unique), "whole_pack_3_adv", List.of(Identifier.of("blockout:goalicon/entity/wolf.png"))));
        ...
        items.add(GoalListItemV2.createImaged("use wolf armor on a wolf", "", 3, List.of(advancement), "wolf_armor_adv", List.of(Identifier.of("blockout:goalicon/item/wolf_armor.png"))));
        ...
        items.add(GoalListItemV2.createImaged("kill the dragon", "", 5, List.of(advancement, kill), "dragon_adv", List.of(Identifier.of("blockout:goalicon/entity/ender_dragon.png"))));
        items.add(GoalListItemV2.createImaged("get the sniper duel advancement", "", 4, List.of(advancement), "sniper_adv", List.of(Identifier.of("blockout:goalicon/entity/skeleton.png"))));
        ...
        items.add(GoalListItemV2.createImaged("complete 15 advancements", "", 3, List.of(C15, advancement), "adv_15", List.of(Identifier.of("blockout:goalicon/advancement/challenge_done.png"))).addBottomRight("15"));
        items.add(GoalListItemV2.createImaged("complete 25 advancements", "", 3, List.of(C25, advancement), "adv_25", List.of(Identifier.of("blockout:goalicon/advancement/challenge_done.png"))).addBottomRight("25"));
        items.add(GoalListItemV2.createImaged("complete 35 advancements", "", 3, List.of(C35, advancement), "adv_35", List.of(Identifier.of("blockout:goalicon/advancement/challenge_done.png"))).addBottomRight("35"));
        // biome goals
        items.add(GoalListItemV2.createImaged("find an ice spikes biome", "", 3, List.of(biomes), "biome_ice_spikes", List.of(Identifier.of("blockout:goalicon/biome/ice_spikes.png"))));
        items.add(GoalListItemV2.createImaged("find a badlands biome", "", 3, List.of(biomes), "biome_badlands", List.of(Identifier.of("blockout:goalicon/biome/badlands.png"))));
        ...
        items.add(GoalListItemV2.createImaged("die by golem", "", 1, List.of(die), "die_golem", List.of(Identifier.of("blockout:goalicon/entity/iron_golem.png"))));
        items.add(GoalListItemV2.createImaged("die by llama", "", 2, List.of(die), "die_llama", List.of(Identifier.of("blockout:goalicon/entity/lama.png"))));
        items.add(GoalListItemV2.createImaged("die by bee sting", "", 1, List.of(die), "die_bee", List.of(Identifier.of("blockout:goalicon/entity/bee.png"))));
        ...
        items.add(GoalListItemV2.createImaged("die by falling stalactite", "", 2, List.of(die), "die_stalactite", List.of(Identifier.of("blockout:goalicon/block/stalactite.png"))));
        items.add(GoalListItemV2.createImaged("die by falling on a stalagmite", "", 2, List.of(die), "die_stalagmite", List.of(Identifier.of("blockout:goalicon/block/stalagmite.png"))));
        ...
        // ride goals
        items.add(GoalListItemV2.createImaged("ride a pig", "", 2, List.of(ride), "ride_pig", List.of(Identifier.of("blockout:goalicon/entity/pig.png"))));
        items.add(GoalListItemV2.createImaged("ride a horse", "", 1, List.of(ride), "ride_horse", List.of(Identifier.of("blockout:goalicon/entity/horse.png"))));
        ...
        items.add(GoalListItemV2.createImaged("take 200 damage", "", 2, List.of(C200), "damage_take_200", List.of(Identifier.of("blockout:goalicon/other/damage.png"))));
        ...
        // tame goals
        items.add(GoalListItemV2.createImaged("tame a cat", "", 2, List.of(tame), "tame_cat", List.of(Identifier.of("blockout:goalicon/entity/cat.png"))));
        items.add(GoalListItemV2.createImaged("tame a wolf", "", 3, List.of(tame), "tame_wolf", List.of(Identifier.of("blockout:goalicon/entity/wolf.png"))));
        items.add(GoalListItemV2.createImaged("tame a horse", "", 1, List.of(tame), "tame_horse", List.of(Identifier.of("blockout:goalicon/entity/horse.png"))));
        items.add(GoalListItemV2.createImaged("tame a llama", "", 3, List.of(tame), "tame_llama", List.of(Identifier.of("blockout:goalicon/entity/lama.png"))));
        items.add(GoalListItemV2.createImaged("tame a parrot", "", 4, List.of(tame), "tame_parrot", List.of(Identifier.of("blockout:goalicon/entity/parrot.png"))));

        // effect goals
        items.add(GoalListItemV2.createImaged("get poisoned", "", 2, List.of(effect), "effect_poison", List.of(Identifier.of("blockout:goalicon/effect/poison.png"))));
        items.add(GoalListItemV2.createImaged("get weakness", "", 3, List.of(effect), "effect_weakness", List.of(Identifier.of("blockout:goalicon/effect/weakness.png"))));
        items.add(GoalListItemV2.createImaged("get jump boost", "", 3, List.of(effect), "effect_jump_boost", List.of(Identifier.of("blockout:goalicon/effect/jump_boost.png"))));
        items.add(GoalListItemV2.createImaged("get fire resistance", "", 4, List.of(effect, nether), "effect_fire_resistance", List.of(Identifier.of("blockout:goalicon/effect/fire_resistance.png"))));
        items.add(GoalListItemV2.createImaged("get infested", "", 3, List.of(effect, nether), "effect_infested", List.of(Identifier.of("blockout:goalicon/effect/infested.png"))));
        items.add(GoalListItemV2.createImaged("get glowing", "", 3, List.of(effect, nether), "effect_glowing", List.of(Identifier.of("blockout:goalicon/effect/glowing.png"))));
        items.add(GoalListItemV2.createImaged("get nausea", "", 3, List.of(effect), "effect_nausea", List.of(Identifier.of("blockout:goalicon/effect/nausea.png")))); // todo iconm
        items.add(GoalListItemV2.createImaged("get absorption", "", 3, List.of(effect), "effect_absorption", List.of(Identifier.of("blockout:goalicon/effect/absorption.png")))); // todo icon
        items.add(GoalListItemV2.createImaged("get mining fatigue", "", 3, List.of(effect), "effect_mining_fatigue", List.of(Identifier.of("blockout:goalicon/effect/mining_fatigue.png")))); // todo icon
        items.add(GoalListItemV2.createImaged("get bad omen", "", 3, List.of(effect), "effect_bad_omen", List.of(Identifier.of("blockout:goalicon/effect/bad_omen.png")))); // todo icon
        ...
        items.add(GoalListItemV2.createImaged("dont get glowing", "", 2, List.of(effect, dont), "dont_glowing", List.of(Identifier.of("blockout:goalicon/effect/glowing.png"))));
        ...
        // level goals
        items.add(GoalListItemV2.createImaged("reach level 15", "", 2, List.of(lvl, C15), "lvl_15", List.of(Identifier.of("blockout:goalicon/entity/experience_orb.png"))).addBottomRight("15"));
        items.add(GoalListItemV2.createImaged("reach level 30", "", 4, List.of(lvl, C30), "lvl_30", List.of(Identifier.of("blockout:goalicon/entity/experience_orb.png"))).addBottomRight("30"));


        // position goals
        items.add(GoalListItemV2.createStackedString("reach bedrock", "", 1, List.of(), "reach_bedrock", List.of("bedrock")));
        items.add(GoalListItemV2.createImaged("reach the sky limit", "", 1, List.of(), "reach_sky_limit", List.of(Identifier.of("blockout:goalicon/item/sun.png"))));
        items.add(GoalListItemV2.createImaged("fall for 300 blocks", "", 2, List.of(C300), "fall_300", List.of(Identifier.of("blockout:goalicon/other/fall.png"))).addBottomRight("300"));
        ...
        // movement goals
        items.add(GoalListItemV2.createImaged("sprint 1 km", "", 1, List.of(km1), "sprint_1km", List.of(Identifier.of("blockout:goalicon/effect/speed.png"))).addBottomRight("1km"));
        items.add(GoalListItemV2.createImaged("swim 1 km", "", 3, List.of(km1), "swim_1km", List.of(Identifier.of("blockout:goalicon/effect/dolphins_grace.png"))).addBottomRight("1km"));
        items.add(GoalListItemV2.createImaged("opponent sneaks", "", 2, List.of(dont), "dont_crouch", List.of(Identifier.of("blockout:goalicon/other/crouch.png"))));
        items.add(GoalListItemV2.createImaged("opponent jumps", "", 3, List.of(dont), "dont_jump", List.of(Identifier.of("blockout:goalicon/other/jump.png"))));
        items.add(GoalListItemV2.createImaged("use elytra to fly 1km", "", 5, List.of(elytra, km1), "fly_elytra", List.of(Identifier.of("blockout:goalicon/item/elytra.png"))).addBottomRight("1km"));


        // brew goals
        items.add(GoalListItemV2.createImaged("brew a potion of invisibility", "", 4, List.of(brew, nether), "brew_invis", List.of(Identifier.of("blockout:goalicon/item/potions/invis.png"))));
        items.add(GoalListItemV2.createImaged("brew a potion of regeneration", "", 4, List.of(brew, nether), "brew_regen", List.of(Identifier.of("blockout:goalicon/item/potions/regen.png"))));
        items.add(GoalListItemV2.createImaged("brew a potion of oozing", "", 4, List.of(brew, nether), "brew_oozing", List.of(Identifier.of("blockout:goalicon/item/potions/oozing.png"))));
        items.add(GoalListItemV2.createImaged("brew a potion of weaving", "", 4, List.of(brew, nether), "brew_weaving", List.of(Identifier.of("blockout:goalicon/item/potions/weaving.png"))));
        items.add(GoalListItemV2.createImaged("brew a potion of leaping", "", 4, List.of(brew, nether), "brew_leaping", List.of(Identifier.of("blockout:goalicon/item/potions/leaping.png"))));
        items.add(GoalListItemV2.createImaged("brew a potion of healing", "", 4, List.of(brew, nether), "brew_healing", List.of(Identifier.of("blockout:goalicon/item/potions/healing.png")))); // todo icons
        items.add(GoalListItemV2.createImaged("brew a potion of harming", "", 4, List.of(brew, nether), "brew_harming", List.of(Identifier.of("blockout:goalicon/item/potions/harming.png")))); // todo icons
        items.add(GoalListItemV2.createImaged("brew a potion of fire resistance", "", 4, List.of(brew, nether), "brew_fire_resistance", List.of(Identifier.of("blockout:goalicon/item/potions/fire_resistance.png")))); // todo icons
        items.add(GoalListItemV2.createImaged("brew a potion of water breathing", "", 4, List.of(brew, nether), "brew_water_breathing", List.of(Identifier.of("blockout:goalicon/item/potions/water_breathing.png"))));  // todo icons
        items.add(GoalListItemV2.createImaged("brew a potion of swiftness", "", 4, List.of(brew, nether), "brew_swiftness", List.of(Identifier.of("blockout:goalicon/item/potions/swiftness.png"))));  // todo icons
        ...
        items.add(GoalListItemV2.createImaged("empty your hunger bar", "", 1, List.of(), "empty_hunger", List.of(Identifier.of("blockout:goalicon/effect/hunger.png"))));

        // more goals
        items.add(GoalListItemV2.createImaged("get more lvls than opponent", "", 1, List.of(more), "more_lvl", List.of(Identifier.of("blockout:goalicon/entity/experience_orb.png"))));
        ...
        BlockoutLogger.log("Registered " + items.size() + " goals");
        ...
        BlockoutLogger.log("Nether goals: " + nether_count);
        BlockoutLogger.log("End goals: " + end_count);
    }
