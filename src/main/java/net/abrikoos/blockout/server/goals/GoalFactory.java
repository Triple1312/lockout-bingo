...
import net.abrikoos.blockout.server.goals.advancement.*;
import net.abrikoos.blockout.server.goals.armor.*;
import net.abrikoos.blockout.server.goals.biome.BiomeGoal;
import net.abrikoos.blockout.server.goals.breed.BreedAnimalGoal;
import net.abrikoos.blockout.server.goals.breed.BreedMultiAnimalsGoal;
import net.abrikoos.blockout.server.goals.brew.BrewPotionGoal;
import net.abrikoos.blockout.server.goals.craft.DuplicateTemplateGoal;
import net.abrikoos.blockout.server.goals.damage.DealDamageGoal;
import net.abrikoos.blockout.server.goals.damage.DontFallDamageGoal;
import net.abrikoos.blockout.server.goals.damage.SnowBallHitGoal;
import net.abrikoos.blockout.server.goals.damage.TakeXDamageGoal;
import net.abrikoos.blockout.server.goals.die.*;
import net.abrikoos.blockout.server.goals.eat.EatFoodGoal;
import net.abrikoos.blockout.server.goals.eat.EatMultiFoodGoal;
import net.abrikoos.blockout.server.goals.eat.EmptyHungerGoal;
import net.abrikoos.blockout.server.goals.effect.*;
import net.abrikoos.blockout.server.goals.inventory.FillInventoryGoal;
import net.abrikoos.blockout.server.goals.inventory.FillUniqueItemsInventoryGoal;
import net.abrikoos.blockout.server.goals.kill.*;
import net.abrikoos.blockout.server.goals.lvl.ReachLvlGoal;
import net.abrikoos.blockout.server.goals.mine.MineDiamondOre;
import net.abrikoos.blockout.server.goals.mine.MineEmeraldOre;
import net.abrikoos.blockout.server.goals.mine.MineGoal;
import net.abrikoos.blockout.server.goals.more.MoreLVLsGoal;
import net.abrikoos.blockout.server.goals.more.ObtainMoreItemGoal;
import net.abrikoos.blockout.server.goals.movement.*;
import net.abrikoos.blockout.server.goals.obtain.*;
import net.abrikoos.blockout.server.goals.position.FallGoal;
import net.abrikoos.blockout.server.goals.position.ReachBedrockGoal;
import net.abrikoos.blockout.server.goals.position.ReachSkyLimitGoal;
import net.abrikoos.blockout.server.goals.ride.RideHorseGoal;
import net.abrikoos.blockout.server.goals.ride.RideMinecartGoal;
import net.abrikoos.blockout.server.goals.ride.RidePigGoal;
import net.abrikoos.blockout.server.goals.tame.TameAnimalGoal;
import net.abrikoos.blockout.server.goals.tools.BreakItemsGoal;
import net.abrikoos.blockout.server.goals.tools.BreakXPickaxes;
import net.abrikoos.blockout.server.goals.use.ComposterGoal;
import net.abrikoos.blockout.server.goals.use.PotPlantGoal;
import net.abrikoos.blockout.server.goals.use.UseBlockGoal;
...
public class GoalFactory {
    ...
    public static BlockoutGoal buildGoal(String goalid, int id) {
