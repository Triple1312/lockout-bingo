...
import net.abrikoos.blockout.util.EntityAssets;
...
public class GoalListEntityItem extends GoalListItem {
    ...
    public GoalListEntityItem(String name, String description, int difficulty, List<BlockoutGoalTag> tags, String id, List<EntityType> entities) {
