package net.abrikoos.blockout.server.goals.brew;

import net.abrikoos.blockout.server.goals.BlockoutGoal;
import net.abrikoos.blockout.server.listeners.ScreenSlotClickListener;
...
// todo not working
public class BrewPotionGoal extends BlockoutGoal {
