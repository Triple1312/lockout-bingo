...
public class Blockout implements ModInitializer {
	...
	public void onInitialize() {
		...
		BlockoutLogger.log("Hello Fabric world!");
...
//			BlockoutLogger.log("Player " + client.player().getUuidAsString() + " joined team " + payload.teamid());
//		});
//
