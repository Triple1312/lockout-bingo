package net.abrikoos.blockout.client.gui.screens;
...
import net.abrikoos.blockout.client.gui.screens.tabscreen.BlockoutTabManager;
import net.abrikoos.blockout.client.gui.screens.tabscreen.BlockoutTabNavigationWidget;
import net.abrikoos.blockout.client.gui.tabs.BoardTab3;
import net.abrikoos.blockout.client.gui.tabs.TeamsTab;
...
public class ScreenScreen extends Screen {
    ...
    private BlockoutTabNavigationWidget tabNavigation;
    private BlockoutTabManager tabManager; // = new BlockoutTabManager(this::addDrawableChild, this::remove);
    ...
    public void init() {
        ...
        this.tabManager = new BlockoutTabManager(this::addDrawableChild, this::remove);
        this.tabManager.subscribeTabChangeEvent(this::tabchanged);
        if (ClientGameStateV2.isGameRunning()) {
            this.tabNavigation = BlockoutTabNavigationWidget.builder(this.tabManager, this.width)
...
//                }
    ...
    public void teamsChanged(TeamRegV2 reg) {
        BlockoutLogger.log("Teams Changed");
        ...
        MainTab() {
            ...
            adder.add(
                ButtonWidget.builder(
                    Text.of("Lockout"), btn -> {
                        client.setScreen(new NewBlockoutScreen(ScreenScreen.this));
                    }
                ).width(120).build(),
                positioner
            );
            ...
            adder.add(
                ButtonWidget.builder(
                    Text.of("Single Block"), btn -> {
                        client.setScreen(new NewBlockoutScreen(ScreenScreen.this, "single_block"));
                    }
                ).width(120).build(),
                positioner
            );
            ...
            adder.add(
                ButtonWidget.builder(
                    Text.of("Block Swap"), btn -> {
                        client.setScreen(new NewBlockoutScreen(ScreenScreen.this, "block_swap"));
                    }
                ).width(120).build(),
                positioner
            );
