package net.abrikoos.blockout.client.gui.tabs;
...
import net.abrikoos.blockout.client.gui.goalExplanations.GoalExplanationRegistry;
import net.abrikoos.blockout.networkv2.compass.AskCompassPacket;
import net.abrikoos.blockout.networkv2.game.EndGamePacket;
        ...
        public BoardTabWidget() {
            ...
            this.textSize = ButtonWidget.builder(Text.of("Set text size"), button -> {
                try {
                    ...
                    BlockoutLogger.log("Invalid number format for text size: " + textFieldWidget.getText());
                }
...
//                        BlockoutLogger.log("Error drawing goal " + goals.get(i).goalName() + "at boardtab");
//                    }
...
//                }
                if(!ClientGameStateV2.gameHasStarted()) {
                    ...
                    BlockoutUtils.drawCenteredText(context, client.textRenderer, "Start in: " + ClientGameStateV2.countDownTime() + 's', tabsizewidth / 2, topY - goalwidthheight/2, 0xffffffff, true);
                ...
                int tabsizewidth = this.width;
                int tabsizeheight = this.height;
                BlockoutUtils.drawCenteredText(context, client.textRenderer, "Start a game to show the board", tabsizewidth / 2, tabsizeheight / 2, 0xffffffff, true);
//                context.drawText(client.textRenderer, Text.of("Start a game to show the board"), tabsizewidth / 2, tabsizeheight / 2, 0xffffffff, true);
        ...
        static class CompassButton extends ClickableWidget{
            ...
            protected void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
                ...
                context.drawTexture(Identifier.of("blockout", "textures/item/compass_20.png"), this.getX(), this.getY(), 0, 0, this.width, this.height, 16, 16);
            }
