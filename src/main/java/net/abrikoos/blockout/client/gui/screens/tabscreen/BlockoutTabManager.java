...
public class BlockoutTabManager extends TabManager {

    public List<Consumer<Tab>> listeners = new ArrayList<>();

    public BlockoutTabManager(Consumer<ClickableWidget> tabLoadConsumer, Consumer<ClickableWidget> tabUnloadConsumer) {
