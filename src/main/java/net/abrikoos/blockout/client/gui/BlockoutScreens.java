...
import net.abrikoos.blockout.client.gui.screens.*;
import net.minecraft.client.MinecraftClient;
import net.minecraft.client.gui.DrawContext;

public class BlockoutScreens {
...
//    private static
    ...
    private static BlockoutScreens instance;

    private  BlockoutScreens() {
    }


    public static BlockoutScreens getInstance() {
        if (instance == null) {
            instance = new BlockoutScreens();
        }
        return instance;
    }
...
//    }
    ...
    public static boolean open() {
        BlockoutLogger.log("Opening screen: " + currentScreen);
