package net.abrikoos.blockout.client.gui.screens.tabscreen;
...
public class BlockoutTabNavigationWidget extends AbstractParentElement implements Drawable, Selectable {
    ...
    private final BlockoutTabManager tabManager;
    private final List<Tab> tabs = new ArrayList<>();
    private final List<TabButtonWidget> tabButtons;

    BlockoutTabNavigationWidget(int x, BlockoutTabManager tabManager, Iterable<Tab> tabs) {
        this.tabNavWidth = x;
    ...
    public static BlockoutTabNavigationWidget.Builder builder(BlockoutTabManager tabManager, int width) {
        return new BlockoutTabNavigationWidget.Builder(tabManager, width);
    }
    ...
    public static class Builder {
        ...
        Builder(BlockoutTabManager tabManager, int width) {
            this.tabManager = tabManager;
            this.width = width;
        }

        public BlockoutTabNavigationWidget.Builder tabs(Tab... tabs) {
            Collections.addAll(this.tabs, tabs);
            return this;
        }

        public BlockoutTabNavigationWidget.Builder tabs(Iterable<Tab> tabs) {
            tabs.forEach(this.tabs::add);
            return this;
        }

        public BlockoutTabNavigationWidget build() {
            return new BlockoutTabNavigationWidget(this.width, this.tabManager, this.tabs);
        }
    }
}
