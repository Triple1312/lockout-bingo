...
public class NewBlockoutScreen extends Screen {
    final Screen parent;
    ...
    BlockoutTabNavigationWidget tabNavigation;
    BlockoutTabManager tabManager = new BlockoutTabManager(this::addDrawableChild, this::remove);
    ...
    protected NewBlockoutScreen(Screen parent) {
        this(parent, "lockout");
    }

    protected NewBlockoutScreen(Screen parent, String gameMode) {
...
//        this.init();
    ...
    class MainTab extends GridScreenTab {
        ...
        public MainTab(NewBlockoutScreen parent) {
            super(Text.of("Game"));
            this.parent = parent;
...
//            adder.add(BlockoutSlider.<Integer>builder(Text.of("3"), e->{}).values(Arrays.asList(1, 2, 3, 4, 5)).defaultValue(3).build() );
//            adder.add(BlockoutSlider.<Integer>builder(Text.of("25"), e->{}).values(Arrays.asList(9, 25, 49)).defaultValue(25).build());
