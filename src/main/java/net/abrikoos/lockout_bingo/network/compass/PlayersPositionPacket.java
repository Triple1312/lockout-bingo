package net.abrikoos.lockout_bingo.network.compass;
...
public record PlayersPositionPacket(
    ...
    public final static Id<PlayersPositionPacket> ID = new CustomPayload.Id<>(Identifier.of("lockout-bingo", "players_position"));
