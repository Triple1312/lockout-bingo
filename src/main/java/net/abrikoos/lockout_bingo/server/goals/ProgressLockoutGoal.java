...
abstract public class ProgressLockoutGoal extends LockoutGoal{
    public ProgressLockoutGoal(int id) {
        super(id);
    }
    ...
    public class Progress{
        ...
        public void addEntry(String key, String value){
            ...
            if (!current.contains(value)){
                ...
                LockoutLogger.log("Tried to add duplicate entry to progress key " + key + " with value " + value);
            }
        ...
        public void addCount(String key, int count){
            try {
                ...
                LockoutLogger.log("Failed to add count to progress key " + key + " with count " + count);
            }
