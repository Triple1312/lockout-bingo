...
public class GoalItemRegistry {
    ...
    public GoalItemRegistry() {
        ...
        items.add(new GoalListObtainItem("obtain end crystal", "", 3, List.of(nether, obtain), "obtain_end_crystal", List.of(Items.END_CRYSTAL.getDefaultStack())));
        items.add(new GoalListObtainItem("obtain bell", "", 2, List.of(village, obtain), "obtain_bell", List.of(Items.BELL.getDefaultStack())));
        ...
        items.add(new GoalListItem("obtain a bottle o enchanting", "obtain bottle o enchanting", 1, List.of(obtain), "obtain_bottle_o_enchanting", List.of(Identifier.of("lockout-bingo:goalicon/item/bottle_o_enchanting.png"))));
        items.add(new GoalListObtainItem("obtain a slime block", "", 1, List.of(obtain), "obtain_slime_block", List.of(Items.SLIME_BLOCK.getDefaultStack())));
        items.add(new GoalListObtainItem("obtain a cake", "", 3, List.of( obtain), "obtain_cake", List.of(Items.CAKE.getDefaultStack())));
        items.add(new GoalListObtainItem("obtain a soul lantern", "", 2, List.of(nether, obtain), "obtain_soul_lantern", List.of(Items.SOUL_LANTERN.getDefaultStack())));
        items.add(new GoalListObtainItem("obtain heart of the sea", "", 2, List.of(obtain), "obtain_heart_of_the_sea", List.of(Items.HEART_OF_THE_SEA.getDefaultStack())));
        items.add(new GoalListObtainItem("obtain sponge", "", 4, List.of(obtain), "obtain_sponge", List.of(Items.SPONGE.getDefaultStack())));
        items.add(new GoalListObtainItem("obtain an end rod", "", 5, List.of(end, obtain), "obtain_end_rod", List.of(Items.END_ROD.getDefaultStack())));
        items.add(new GoalListObtainItem("obtain sea lantern", "", 4, List.of(silk_touch, obtain), "obtain_sea_lantern", List.of(Items.SEA_LANTERN.getDefaultStack())));
        items.add(new GoalListObtainItem("obtain mossy stone brick wall", "", 3, List.of( obtain), "obtain_mossy_stone_brick_wall", List.of(Items.MOSSY_STONE_BRICK_WALL.getDefaultStack())));
        items.add(new GoalListObtainItem("obtain crying obsidian", "", 2, List.of(nether, obtain), "obtain_crying_obsidian", List.of(Items.CRYING_OBSIDIAN.getDefaultStack())));
        items.add(new GoalListObtainItem("obtain mushroom stem", "", 3, List.of(silk_touch, obtain), "obtain_mushroom_stem", List.of(Items.MUSHROOM_STEM.getDefaultStack())));
        items.add(new GoalListObtainItem("obtain a bubble coral block", "", 3, List.of(silk_touch, obtain), "obtain_coral_block", List.of(Items.BUBBLE_CORAL_BLOCK.getDefaultStack())));
        items.add(new GoalListObtainItem("obtain a shulker box", "", 5, List.of(end, obtain), "obtain_shulker_box", List.of(Items.SHULKER_BOX.getDefaultStack())));
        items.add(new GoalListItem("obtain a bookshelf", "", 2, List.of( obtain), "obtain_bookshelf", List.of(Identifier.of("lockout-bingo:goalicon/block/bookshelf.png"))));
        items.add(new GoalListItem("obtain flowering azelia", "", 3, List.of( obtain), "obtain_flowering_azelia", List.of(Identifier.of("lockout-bingo:goalicon/block/flowering_azelia.png"))));
        items.add(new GoalListItem("obtain scaffolding", "", 3, List.of( obtain), "obtain_scaffolding", List.of(Identifier.of("lockout-bingo:goalicon/block/scaffolding.png"))));
        items.add(new GoalListItem("obtain a bucket of powdered snow", "", 3, List.of( obtain), "obtain_snow_bucket", List.of(Identifier.of("lockout-bingo:goalicon/item/powder_snow_bucket.png"))));
        items.add(new GoalListItem("obtain ancient debris", "", 5, List.of(nether, obtain), "obtain_ancient_debris", List.of(Identifier.of("lockout-bingo:goalicon/block/ancient_debris.png"))));
        items.add(new GoalListItem("obtain an ender chest", "", 4, List.of(nether, obtain), "obtain_ender_chest", List.of(Identifier.of("lockout-bingo:goalicon/block/ender_chest.png"))));
        items.add(new GoalListItem("obtain the dragon egg", "", 5, List.of(end, obtain), "obtain_dragon_egg", List.of(Identifier.of("lockout-bingo:goalicon/block/dragon_egg.png"))));
        ...
        items.add(new GoalListItem("obtain TNT", "", 2, List.of( obtain), "obtain_tnt", List.of(Identifier.of("lockout-bingo:goalicon/block/tnt.png"))));
        items.add(new GoalListItem("obtain mud brick wall", "", 3, List.of( obtain), "obtain_mud_brick_wall", List.of(Identifier.of("lockout-bingo:goalicon/block/mud_brick_wall.png"))));
        items.add(new GoalListItem("obtain a calibrated sculk sensor", "", 4, List.of( obtain), "obtain_calibrated_sculk_sensor", List.of(Identifier.of("lockout-bingo:goalicon/block/calibrated_sculk_sensor.png"))));
        items.add(new GoalListItem("obtain blue ice", "", 4, List.of(silk_touch, obtain), "obtain_blue_ice", List.of(Identifier.of("lockout-bingo:goalicon/block/blue_ice.png"))));
        items.add(new GoalListItem("obtain a cobweb", "", 2, List.of( obtain), "obtain_cobweb", List.of(Identifier.of("minecraft:textures/block/cobweb.png"))));
        items.add(new GoalListItem("obtain goat horn", "", 3, List.of(obtain), "obtain_goat_horn", List.of(Identifier.of("minecraft:textures/item/goat_horn.png"))));
        items.add(new GoalListItem("obtain a nautilus shell", "", 2, List.of(obtain), "obtain_nautilus_shell", List.of(Identifier.of("minecraft:textures/item/nautilus_shell.png"))));
        items.add(new GoalListItem("obtain exposed cut copper stairs", "", 4, List.of(obtain), "obtain_exposed_copper_stairs", List.of(Identifier.of("lockout-bingo:goalicon/block/exposed_cut_copper_stairs.png"))));
        items.add(new GoalListItem("obtain a copper bulb", "", 4, List.of(nether, obtain), "obtain_copper_bulb", List.of(Identifier.of("lockout-bingo:goalicon/block/lit_copper_bulb.png"))));
        items.add(new GoalListItem("obtain a daylight detector", "", 2, List.of(nether, obtain), "obtain_daylight_detector", List.of(Identifier.of("lockout-bingo:goalicon/block/daylight_detector.png"))));
        items.add(new GoalListItem("obtain a redstone repeater", "", 2, List.of(redstone, obtain), "obtain_repeater", List.of(Identifier.of("lockout-bingo:goalicon/block/repeater.png"))));
        items.add(new GoalListItem("obtain a piston", "", 2, List.of(redstone, obtain), "obtain_piston", List.of(Identifier.of("lockout-bingo:goalicon/block/piston.png"))));
        items.add(new GoalListItem("obtain a sticky piston", "", 3, List.of(redstone, obtain), "obtain_sticky_piston", List.of(Identifier.of("lockout-bingo:goalicon/block/sticky_piston.png"))));
        items.add(new GoalListItem("obtain a dispenser", "", 2, List.of(redstone, obtain), "obtain_dispenser", List.of(Identifier.of("lockout-bingo:goalicon/block/dispenser.png"))));
        items.add(new GoalListItem("obtain an activator rail", "", 2, List.of(redstone, obtain), "obtain_activator_rail", List.of(Identifier.of("minecraft:textures/block/activator_rail.png"))));
        items.add(new GoalListItem("obtain a detector rail", "", 2, List.of(redstone, obtain), "obtain_detector_rail", List.of(Identifier.of("minecraft:textures/block/detector_rail.png"))));
        items.add(new GoalListItem("obtain a powered rail", "", 3, List.of(redstone, obtain), "obtain_powered_rail", List.of(Identifier.of("minecraft:textures/block/powered_rail.png"))));
        items.add(new GoalListItem("obtain a clock", "", 1, List.of(redstone, obtain), "obtain_clock", List.of(Identifier.of("lockout-bingo:goalicon/item/clock.png"))));
        items.add(new GoalListItem("obtain a comparator", "", 2, List.of(redstone, obtain), "obtain_comparator", List.of(Identifier.of("lockout-bingo:goalicon/block/comparator.png"))));
        items.add(new GoalListItem("obtain an observer", "", 3, List.of(redstone, obtain), "obtain_observer", List.of(Identifier.of("lockout-bingo:goalicon/block/observer.png"))));
        items.add(new GoalListItem("obtain every type of raw ore block", "", 4, List.of( obtain), "obtain_all_raw_ore_blocks", List.of(Identifier.of("minecraft:textures/block/raw_iron_block.png"), Identifier.of("minecraft:textures/block/raw_copper_block.png"), Identifier.of("minecraft:textures/block/raw_gold_block.png"))));

        items.add(new GoalListItem("obtain 15 unique types of stairs", "", 5, List.of(C15, unique, obtain), "stairs_15", List.of(Identifier.of("lockout-bingo:goalicon/block/stairs/oak_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/smooth_quartz_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/smooth_red_sandstone_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/deepslate_tile_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/cherry_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/stone_brick_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/cut_copper_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/polished_granite_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/bamboo_mosaic_stairs.png"),Identifier.of("lockout-bingo:goalicon/block/stairs/end_stone_brick_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/dark_prismarine_stairs.png"),Identifier.of("lockout-bingo:goalicon/block/stairs/mossy_cobblestone_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/weathered_cut_copper_stairs.png"))));
        items.add(new GoalListItem("obtain 5 unique types of stairs", "", 2, List.of(C5, unique, obtain), "stairs_5", List.of(Identifier.of("lockout-bingo:goalicon/block/stairs/oak_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/smooth_quartz_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/smooth_red_sandstone_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/deepslate_tile_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/cherry_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/stone_brick_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/cut_copper_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/polished_granite_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/bamboo_mosaic_stairs.png"),Identifier.of("lockout-bingo:goalicon/block/stairs/end_stone_brick_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/dark_prismarine_stairs.png"),Identifier.of("lockout-bingo:goalicon/block/stairs/mossy_cobblestone_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/weathered_cut_copper_stairs.png"))));
        items.add(new GoalListItem("obtain 10 unique types of stairs", "", 3, List.of(C10, unique, obtain), "stairs_10", List.of(Identifier.of("lockout-bingo:goalicon/block/stairs/oak_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/smooth_quartz_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/smooth_red_sandstone_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/deepslate_tile_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/cherry_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/stone_brick_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/cut_copper_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/polished_granite_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/bamboo_mosaic_stairs.png"),Identifier.of("lockout-bingo:goalicon/block/stairs/end_stone_brick_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/dark_prismarine_stairs.png"),Identifier.of("lockout-bingo:goalicon/block/stairs/mossy_cobblestone_stairs.png"), Identifier.of("lockout-bingo:goalicon/block/stairs/weathered_cut_copper_stairs.png"))));

        // tool goals
        items.add(new GoalListItem("obtain a full set of wooden tools", "", 1, List.of(tools, obtain), "obtain_wooden_toolset", List.of(Identifier.of("minecraft:textures/item/wooden_hoe.png"), Identifier.of("minecraft:textures/item/wooden_hoe.png"), Identifier.of("minecraft:textures/item/wooden_pickaxe.png"), Identifier.of("minecraft:textures/item/wooden_shovel.png"), Identifier.of("minecraft:textures/item/wooden_sword.png"))));
        items.add(new GoalListItem("obtain a full set of stone tools", "", 1, List.of(tools, obtain), "obtain_stone_toolset", List.of(Identifier.of("minecraft:textures/item/stone_hoe.png"), Identifier.of("minecraft:textures/item/stone_hoe.png"), Identifier.of("minecraft:textures/item/stone_pickaxe.png"), Identifier.of("minecraft:textures/item/stone_shovel.png"), Identifier.of("minecraft:textures/item/stone_sword.png"))));
        items.add(new GoalListItem("obtain a full set of iron tools", "", 3, List.of(tools, obtain), "obtain_iron_toolset", List.of(Identifier.of("minecraft:textures/item/iron_hoe.png"), Identifier.of("minecraft:textures/item/iron_hoe.png"), Identifier.of("minecraft:textures/item/iron_pickaxe.png"), Identifier.of("minecraft:textures/item/iron_shovel.png"), Identifier.of("minecraft:textures/item/iron_sword.png"))));
        items.add(new GoalListItem("obtain a full set of golden tools", "", 4, List.of(tools, obtain), "obtain_golden_toolset", List.of(Identifier.of("minecraft:textures/item/golden_hoe.png"), Identifier.of("minecraft:textures/item/golden_hoe.png"), Identifier.of("minecraft:textures/item/golden_pickaxe.png"), Identifier.of("minecraft:textures/item/golden_shovel.png"), Identifier.of("minecraft:textures/item/golden_sword.png"))));
        items.add(new GoalListItem("obtain a full set of diamond tools", "", 5, List.of(tools, obtain), "obtain_diamond_toolset", List.of(Identifier.of("minecraft:textures/item/diamond_hoe.png"), Identifier.of("minecraft:textures/item/diamond_hoe.png"), Identifier.of("minecraft:textures/item/diamond_pickaxe.png"), Identifier.of("minecraft:textures/item/diamond_shovel.png"), Identifier.of("minecraft:textures/item/diamond_sword.png"))));
        items.add(new GoalListItem("obtain every type of axe", "", 4, List.of(tools, obtain), "obtain_all_axes", List.of(Identifier.of("minecraft:textures/item/wooden_axe.png"), Identifier.of("minecraft:textures/item/stone_axe.png"), Identifier.of("minecraft:textures/item/iron_axe.png"), Identifier.of("minecraft:textures/item/golden_axe.png"), Identifier.of("minecraft:textures/item/diamond_axe.png"), Identifier.of("minecraft:textures/item/netherite_axe.png"))));
        items.add(new GoalListItem("obtain every type of hoe", "", 4, List.of(tools, obtain), "obtain_all_hoes", List.of(Identifier.of("minecraft:textures/item/wooden_hoe.png"), Identifier.of("minecraft:textures/item/stone_hoe.png"), Identifier.of("minecraft:textures/item/iron_hoe.png"), Identifier.of("minecraft:textures/item/golden_hoe.png"), Identifier.of("minecraft:textures/item/diamond_hoe.png"), Identifier.of("minecraft:textures/item/netherite_hoe.png"))));
        items.add(new GoalListItem("obtain every type of pickaxe", "", 4, List.of(tools, obtain), "obtain_all_pickaxes", List.of(Identifier.of("minecraft:textures/item/wooden_pickaxe.png"), Identifier.of("minecraft:textures/item/stone_pickaxe.png"), Identifier.of("minecraft:textures/item/iron_pickaxe.png"), Identifier.of("minecraft:textures/item/golden_pickaxe.png"), Identifier.of("minecraft:textures/item/diamond_pickaxe.png"), Identifier.of("minecraft:textures/item/netherite_pickaxe.png"))));
        items.add(new GoalListItem("obtain every type of shovel", "", 4, List.of(tools, obtain), "obtain_all_shovels", List.of(Identifier.of("minecraft:textures/item/wooden_shovel.png"), Identifier.of("minecraft:textures/item/stone_shovel.png"), Identifier.of("minecraft:textures/item/iron_shovel.png"), Identifier.of("minecraft:textures/item/golden_shovel.png"), Identifier.of("minecraft:textures/item/diamond_shovel.png"), Identifier.of("minecraft:textures/item/netherite_shovel.png"))));
        items.add(new GoalListItem("obtain every type of sword", "", 4, List.of(tools, obtain), "obtain_all_swords", List.of(Identifier.of("minecraft:textures/item/wooden_sword.png"), Identifier.of("minecraft:textures/item/stone_sword.png"), Identifier.of("minecraft:textures/item/iron_sword.png"), Identifier.of("minecraft:textures/item/golden_sword.png"), Identifier.of("minecraft:textures/item/diamond_sword.png"), Identifier.of("minecraft:textures/item/netherite_sword.png"))));
        ...
        items.add(new GoalListItem("wear a carved pumpkin for 1 minute", "", 3, List.of(armor), "wear_pumpkin", List.of(Identifier.of("lockout-bingo:goalicon/block/carved_pumpkin.png")))); // todo change time


        items.add(new GoalListItem("obtain 4 types of seeds", "", 3, List.of(C4, unique, obtain), "obtain_all_seeds", List.of(Identifier.of("minecraft:textures/item/wheat_seeds.png"), Identifier.of("minecraft:textures/item/beetroot_seeds.png"), Identifier.of("minecraft:textures/item/melon_seeds.png"), Identifier.of("minecraft:textures/item/pumpkin_seeds.png"), Identifier.of("minecraft:textures/item/torchflower_seeds.png"))));
        items.add(new GoalListItem("obtain 6 types of flowers", "", 3, List.of(C6, unique, obtain), "obtain_6_flowers", List.of(Identifier.of("minecraft:textures/block/poppy.png"), Identifier.of("minecraft:textures/block/dandelion.png"), Identifier.of("minecraft:textures/block/blue_orchid.png"), Identifier.of("minecraft:textures/block/allium.png"), Identifier.of("minecraft:textures/block/azure_bluet.png"), Identifier.of("minecraft:textures/block/red_tulip.png"), Identifier.of("minecraft:textures/block/orange_tulip.png"), Identifier.of("minecraft:textures/block/white_tulip.png"), Identifier.of("minecraft:textures/block/pink_tulip.png"), Identifier.of("minecraft:textures/block/oxeye_daisy.png"), Identifier.of("minecraft:textures/block/cornflower.png"), Identifier.of("minecraft:textures/block/lily_of_the_valley.png"), Identifier.of("minecraft:textures/block/wither_rose.png"))));
        items.add(new GoalListItem("obtain black glazed terracotta", "", 2, List.of( obtain), "obtain_black_glazed_terracotta", List.of(Identifier.of("lockout-bingo:goalicon/block/black_glazed_terracotta.png"))));
        items.add(new GoalListItem("obtain all saplings", "", 4, List.of(obtain), "obtain_all_saplings", List.of(Identifier.of("minecraft:textures/block/oak_sapling.png"), Identifier.of("minecraft:textures/block/spruce_sapling.png"), Identifier.of("minecraft:textures/block/birch_sapling.png"), Identifier.of("minecraft:textures/block/jungle_sapling.png"), Identifier.of("minecraft:textures/block/acacia_sapling.png"), Identifier.of("minecraft:textures/block/dark_oak_sapling.png"))));
        items.add(new GoalListItem("obtain 2 music disks", "", 3, List.of(C2, obtain), "obtain_2_music_disks", List.of(Identifier.of("minecraft:textures/item/music_disc_11.png"), Identifier.of("minecraft:textures/item/music_disc_13.png"), Identifier.of("minecraft:textures/item/music_disc_blocks.png"), Identifier.of("minecraft:textures/item/music_disc_cat.png"), Identifier.of("minecraft:textures/item/music_disc_chirp.png"), Identifier.of("minecraft:textures/item/music_disc_far.png"), Identifier.of("minecraft:textures/item/music_disc_mall.png"), Identifier.of("minecraft:textures/item/music_disc_mellohi.png"), Identifier.of("minecraft:textures/item/music_disc_stal.png"), Identifier.of("minecraft:textures/item/music_disc_strad.png"), Identifier.of("minecraft:textures/item/music_disc_wait.png"), Identifier.of("minecraft:textures/item/music_disc_ward.png"))));
        items.add(new GoalListItem("obtain all types of horse armor", "", 4, List.of(nether, unique, obtain), "obtain_all_harmor", List.of(Identifier.of("minecraft:textures/item/iron_horse_armor.png"), Identifier.of("minecraft:textures/item/golden_horse_armor.png"), Identifier.of("minecraft:textures/item/diamond_horse_armor.png"))));
...
//        items.add(new GoalListItem("eat honeycomb", "", 1, List.of(), "eat_honeycomb", List.of(Identifier.of("minecraft:textures/item/honeycomb.png"))));
        ...
        items.add(new GoalListItem("get a wither skeleton skull", "", 5, List.of(advancement, nether, obtain), "spooky_scary_skeletons_adv", List.of(Identifier.of("lockout-bingo:goalicon/item/wither_skeleton_skull.png"))));
        ...
        items.add(new GoalListItem("obtain a sniffer egg", "", 3, List.of(advancement, obtain), "sniffer_egg_adv", List.of(Identifier.of("minecraft:textures/item/sniffer_egg.png"))));
        ...
        items.add(new GoalListItem("die by intentional game design", "", 2, List.of(die), "die_bed", List.of(Identifier.of("lockout-bingo:goalicon/block/bed.png"), Identifier.of("lockout-bingo:goalicon/block/respawn_anchor_charged.png"))));
        ...
        items.add(new GoalListItem("ride a minecart", "", 3, List.of(), "ride_minecart", List.of(Identifier.of("lockout-bingo:goalicon/entity/minecart.png"))));
        ...
        //wool goals
        items.add(new GoalListItem("obtain a stack of lime wool", "", 3, List.of(wool, C64, obtain), "64_lime_wool", List.of(Identifier.of("lockout-bingo:goalicon/block/wool/lime_wool.png"))));
        items.add(new GoalListItem("obtain a stack of gray wool", "", 3, List.of(wool, C64, obtain), "64_gray_wool", List.of(Identifier.of("lockout-bingo:goalicon/block/wool/gray_wool.png"))));
        items.add(new GoalListItem("obtain a stack of cyan wool", "", 3, List.of(wool, C64, obtain), "64_cyan_wool", List.of(Identifier.of("lockout-bingo:goalicon/block/wool/cyan_wool.png"))));
        items.add(new GoalListItem("obtain a stack of brown wool", "", 3, List.of(wool, C64, obtain), "64_brown_wool", List.of(Identifier.of("lockout-bingo:goalicon/block/wool/brown_wool.png"))));
