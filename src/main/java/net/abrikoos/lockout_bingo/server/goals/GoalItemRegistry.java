...
public class GoalItemRegistry {
    ...
    public GoalItemRegistry() {
        ...
        items.add(new GoalListBlockItem("obtain 15 unique types of stairs", "", 5, List.of(C15, unique, obtain), "stairs_15", List.of(Items.OAK_STAIRS.getDefaultStack(), Items.SMOOTH_QUARTZ_STAIRS.getDefaultStack().copyWithCount(15), Items.SMOOTH_RED_SANDSTONE_STAIRS.getDefaultStack().copyWithCount(15), Items.DEEPSLATE_TILE_STAIRS.getDefaultStack().copyWithCount(15), Items.CHERRY_STAIRS.getDefaultStack().copyWithCount(15), Items.STONE_BRICK_STAIRS.getDefaultStack().copyWithCount(15), Items.CUT_COPPER_STAIRS.getDefaultStack().copyWithCount(15), Items.POLISHED_GRANITE_STAIRS.getDefaultStack().copyWithCount(15), Items.BAMBOO_MOSAIC_STAIRS.getDefaultStack().copyWithCount(15), Items.END_STONE_BRICK_STAIRS.getDefaultStack().copyWithCount(15), Items.DARK_PRISMARINE_STAIRS.getDefaultStack().copyWithCount(15), Items.MOSSY_COBBLESTONE_STAIRS.getDefaultStack().copyWithCount(15), Items.WEATHERED_CUT_COPPER_STAIRS.getDefaultStack().copyWithCount(15))));
        items.add(new GoalListBlockItem("obtain 5 unique types of stairs", "", 2, List.of(C5, unique, obtain), "stairs_5", List.of(Items.OAK_STAIRS.getDefaultStack().copyWithCount(5), Items.SMOOTH_QUARTZ_STAIRS.getDefaultStack().copyWithCount(5), Items.SMOOTH_RED_SANDSTONE_STAIRS.getDefaultStack().copyWithCount(5), Items.DEEPSLATE_TILE_STAIRS.getDefaultStack().copyWithCount(5), Items.CHERRY_STAIRS.getDefaultStack().copyWithCount(5), Items.STONE_BRICK_STAIRS.getDefaultStack().copyWithCount(5), Items.CUT_COPPER_STAIRS.getDefaultStack().copyWithCount(5), Items.POLISHED_GRANITE_STAIRS.getDefaultStack().copyWithCount(5), Items.BAMBOO_MOSAIC_STAIRS.getDefaultStack().copyWithCount(5), Items.END_STONE_BRICK_STAIRS.getDefaultStack().copyWithCount(5), Items.DARK_PRISMARINE_STAIRS.getDefaultStack().copyWithCount(5), Items.MOSSY_COBBLESTONE_STAIRS.getDefaultStack().copyWithCount(5), Items.WEATHERED_CUT_COPPER_STAIRS.getDefaultStack().copyWithCount(5))));
        items.add(new GoalListBlockItem("obtain 10 unique types of stairs", "", 3, List.of(C10, unique, obtain), "stairs_10", List.of(Items.OAK_STAIRS.getDefaultStack().copyWithCount(10), Items.SMOOTH_QUARTZ_STAIRS.getDefaultStack().copyWithCount(10), Items.SMOOTH_RED_SANDSTONE_STAIRS.getDefaultStack().copyWithCount(10), Items.DEEPSLATE_TILE_STAIRS.getDefaultStack().copyWithCount(10), Items.CHERRY_STAIRS.getDefaultStack().copyWithCount(10), Items.STONE_BRICK_STAIRS.getDefaultStack().copyWithCount(10), Items.CUT_COPPER_STAIRS.getDefaultStack().copyWithCount(10), Items.POLISHED_GRANITE_STAIRS.getDefaultStack().copyWithCount(10), Items.BAMBOO_MOSAIC_STAIRS.getDefaultStack().copyWithCount(10), Items.END_STONE_BRICK_STAIRS.getDefaultStack().copyWithCount(10), Items.DARK_PRISMARINE_STAIRS.getDefaultStack().copyWithCount(10), Items.MOSSY_COBBLESTONE_STAIRS.getDefaultStack().copyWithCount(10), Items.WEATHERED_CUT_COPPER_STAIRS.getDefaultStack().copyWithCount(10))));
        ...
        items.add(new GoalListBlockItem("obtain 4 types of seeds", "", 3, List.of(C4, unique, obtain), "obtain_all_seeds", List.of(Items.WHEAT_SEEDS.getDefaultStack().copyWithCount(4), Items.BEETROOT_SEEDS.getDefaultStack().copyWithCount(4), Items.MELON_SEEDS.getDefaultStack().copyWithCount(4), Items.PUMPKIN_SEEDS.getDefaultStack().copyWithCount(4), Items.TORCHFLOWER_SEEDS.getDefaultStack().copyWithCount(4))));
        items.add(new GoalListBlockItem("obtain 6 types of flowers", "", 3, List.of(C6, unique, obtain), "obtain_6_flowers", List.of(Items.POPPY.getDefaultStack().copyWithCount(6), Items.DANDELION.getDefaultStack().copyWithCount(6), Items.BLUE_ORCHID.getDefaultStack().copyWithCount(6), Items.ALLIUM.getDefaultStack().copyWithCount(6), Items.AZURE_BLUET.getDefaultStack().copyWithCount(6), Items.RED_TULIP.getDefaultStack().copyWithCount(6), Items.ORANGE_TULIP.getDefaultStack().copyWithCount(6), Items.WHITE_TULIP.getDefaultStack().copyWithCount(6),  Items.OXEYE_DAISY.getDefaultStack().copyWithCount(6), Items.CORNFLOWER.getDefaultStack().copyWithCount(6), Items.LILY_OF_THE_VALLEY.getDefaultStack().copyWithCount(6), Items.WITHER_ROSE.getDefaultStack().copyWithCount(6))));
        ...
        items.add(new GoalListBlockItem("obtain 2 music disks", "", 3, List.of(C2, obtain), "obtain_2_music_disks", List.of(Items.MUSIC_DISC_11.getDefaultStack().copyWithCount(2), Items.MUSIC_DISC_13.getDefaultStack().copyWithCount(2), Items.MUSIC_DISC_BLOCKS.getDefaultStack().copyWithCount(2), Items.MUSIC_DISC_CAT.getDefaultStack().copyWithCount(2), Items.MUSIC_DISC_CHIRP.getDefaultStack().copyWithCount(2), Items.MUSIC_DISC_FAR.getDefaultStack().copyWithCount(2), Items.MUSIC_DISC_MALL.getDefaultStack().copyWithCount(2), Items.MUSIC_DISC_MELLOHI.getDefaultStack().copyWithCount(2), Items.MUSIC_DISC_STAL.getDefaultStack().copyWithCount(2), Items.MUSIC_DISC_STRAD.getDefaultStack().copyWithCount(2), Items.MUSIC_DISC_WAIT.getDefaultStack().copyWithCount(2), Items.MUSIC_DISC_WARD.getDefaultStack().copyWithCount(2))));
        ...
        items.add(new GoalListBlockItem("eat 5 unique foods", "", 1, List.of(C5, eat, unique), "eat_5", List.of(Items.APPLE.getDefaultStack().copyWithCount(5))));
        items.add(new GoalListBlockItem("eat 10 unique foods", "", 2, List.of(C10, eat, unique), "eat_10", List.of(Items.APPLE.getDefaultStack().copyWithCount(10))));
        items.add(new GoalListBlockItem("eat 15 unique foods", "", 3, List.of(C15, eat, unique), "eat_15", List.of(Items.APPLE.getDefaultStack().copyWithCount(15))));
        items.add(new GoalListBlockItem("eat 20 unique foods", "", 4, List.of(C20, eat, unique), "eat_20", List.of(Items.APPLE.getDefaultStack().copyWithCount(20))));
