...
public class GoalItemRegistry {
    ...
    public GoalItemRegistry() {
        ...
        items.add(new GoalListItem("obtain a slime block", "", 1, List.of(obtain), "obtain_slime_block", List.of(Identifier.of("lockout-bingo:goalicon/block/slime_block.png"))));
        items.add(new GoalListItem("obtain a cake", "", 3, List.of( obtain), "obtain_cake", List.of(Identifier.of("minecraft:textures/item/cake.png"))));
        items.add(new GoalListItem("obtain a soul lantern", "", 2, List.of(nether, obtain), "obtain_soul_lantern", List.of(Identifier.of("lockout-bingo:goalicon/block/soul_lantern.png"))));
        items.add(new GoalListItem("obtain heart of the sea", "", 2, List.of(obtain), "obtain_heart_of_the_sea", List.of(Identifier.of("minecraft:textures/item/heart_of_the_sea.png"))));
        items.add(new GoalListItem("obtain sponge", "", 4, List.of(obtain), "obtain_sponge", List.of(Identifier.of("lockout-bingo:goalicon/block/sponge.png"))));
        items.add(new GoalListItem("obtain an end rod", "", 5, List.of(end, obtain), "obtain_end_rod", List.of(Identifier.of("lockout-bingo:goalicon/block/end_rod.png"))));
        items.add(new GoalListItem("obtain sea lantern", "", 4, List.of(silk_touch, obtain), "obtain_sea_lantern", List.of(Identifier.of("lockout-bingo:goalicon/block/sea_lantern.png"))));
        items.add(new GoalListItem("obtain mossy stone brick wall", "", 3, List.of( obtain), "obtain_mossy_stone_brick_wall", List.of(Identifier.of("lockout-bingo:goalicon/block/mossy_stone_brick_wall.png"))));
        items.add(new GoalListItem("obtain crying obsidian", "", 2, List.of(nether, obtain), "obtain_crying_obsidian", List.of(Identifier.of("lockout-bingo:goalicon/block/crying_obsidian.png"))));
        items.add(new GoalListItem("obtain mushroom stem", "", 3, List.of(silk_touch, obtain), "obtain_mushroom_stem", List.of(Identifier.of("lockout-bingo:goalicon/block/mushroom_stem.png"))));
        items.add(new GoalListItem("obtain a bubble coral block", "", 3, List.of(silk_touch, obtain), "obtain_coral_block", List.of(Identifier.of("lockout-bingo:goalicon/block/bubble_coral_block.png"))));
        items.add(new GoalListItem("obtain a shulker box", "", 5, List.of(end, obtain), "obtain_shulker_box", List.of(Identifier.of("lockout-bingo:goalicon/block/shulker_box.png"))));
