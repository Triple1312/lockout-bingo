...
//            assert OldTeamRegistry.getTeam(player.teamIndex) != null;
//            OldTeamRegistry.getTeam(player.teamIndex).removePlayer(player.getPlayerUUID().toString());
//        }
//        if (teamIndex == 0) { // if was not in team before
//            player.teamIndex = 0;
//            return;
//        }
//        LockoutTeam team = OldTeamRegistry.getTeam(teamIndex);
//        assert team != null;
...
//        OldTeamRegistry.setAllTeams(teams);
